...
const highlights: Highlight[] = [
    ...
    },
    {
        ...
        description: 'Llevamos tu aplicación a internet de forma rápida y estable. Optimizamos cada detalle para que tu proyecto escale sin problemas.',
        icon: Cloud,
        accentColor: '#f43f5e',
        delay: 0.3,
    },
    {
        ...
        description: 'Creamos software sólido y protegido. Aplicamos las mejores prácticas para que tu aplicación sea segura, rápida y fácil de mantener en el futuro.',
        icon: Shield,
        accentColor: '#f59e0b',
        delay: 0.4,
    },
...
const About: React.FC = () => {
    ...
    return (
        <section ref={sectionRef} className="relative min-h-screen overflow-hidden pt-20 sm:pt-24 md:pt-28 pb-16 sm:pb-20 md:pb-24 bg-slate-950">
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                    <h2 id="skills-heading" className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black tracking-tight leading-[1.1] px-4">
                        ...
                        <span className="block text-slate-400/80 text-xl sm:text-2xl md:text-3xl font-bold mt-3">
